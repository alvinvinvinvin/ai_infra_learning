# Running My First LLM Inference

Goal: Run a 7B model using vLLM on my WSL2 + RTX 5060 setup, and successfully receive responses via HTTP requests.

Week 1: Environment Setup and Initial Run
